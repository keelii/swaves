...
- Web 与路由：补到关键 handler 子集（`/api/slug`、`/api/markdown`、`/dash/posts`、`/dash/tasks`、`/dash/tasks/new`、`/dash/tasks/:id/edit`、`/dash/tasks/:id/delete`、`/dash/tasks/:code/trigger`、`/dash/tasks/:code/runs`）。
