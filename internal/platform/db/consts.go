...
var DefaultSettings = []Setting{
	...
	{Sort: 10, Kind: SettingKindBackupSync, Name: "开启远程备份", Code: "sync_push_enabled", Type: "radio", Value: "1", DefaultOptionValue: "0", Description: "开启后允许将备份推送到远程服务。", Options: `[{"label": "关闭", "value": "0"}, {"label": "开启", "value": "1"}]`},
