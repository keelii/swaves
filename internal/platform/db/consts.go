...
var DefaultSettings = []Setting{
	...
	{Sort: 13, Kind: SettingKindUIExperience, Name: "后台导航宽度", Code: "dash_nav_width", Type: "number", Value: "150", DefaultOptionValue: "150", Description: "管理后台左侧导航栏宽度。", Attrs: `{"min": 150, "max": 480, "step": 5}`},
