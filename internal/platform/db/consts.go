...
var DefaultSettings = []Setting{
	...
	{Sort: 10, Kind: SettingKindBackupSync, Name: "开启远程备份", Code: "sync_push_enabled", Type: "radio", Value: "0", DefaultOptionValue: "0", Description: "开启后允许将备份推送到远程服务。", Options: `[{"label": "关闭", "value": "0"}, {"label": "开启", "value": "1"}]`},
	...
	{Sort: 15, Kind: SettingKindUIExperience, Name: "目录展开", Code: "dash_post_editor_toc_open", Type: "radio", Value: "0", DefaultOptionValue: "0", Description: "目录默认展开状态。", Options: `[{"label": "关闭", "value": "0"}, {"label": "开启", "value": "1"}]`},
	...
	{Sort: 19, Kind: SettingKindUIExperience, Name: "默认分页数量", Code: "page_size", Type: "number", Value: "20", DefaultOptionValue: "10", Description: "系统默认分页数量，当前同时影响前后台列表分页。", Attrs: `{"min": 1, "max": 100}`},
}
