...
var DefaultSettings = []Setting{
	...
	{Sort: 14, Kind: SettingKindSiteBasics, Name: "站点关键字", Code: "site_keywords", Type: "text", Value: "", Description: "关键字，英文,分割多个"},
	...
	{Sort: 10, Kind: SettingKindBackupSync, Name: "开启远程备份", Code: "sync_push_enabled", Type: "radio", Value: "0", DefaultOptionValue: "0", Description: "开启后允许将备份推送到远程服务。", Options: BooleanOptions},
	{Sort: 11, Kind: SettingKindBackupSync, Name: "远程备份服务", Code: "sync_push_provider", Type: "select", Value: "s3", DefaultOptionValue: "s3", Description: "选择 ImageKit 时，将复用“资源与云服务”中的 ImageKit 配置。", Options: `[{"label": "S3", "value": "s3"}, {"label": "ImageKit", "value": "imagekit"}]`},
	{Sort: 13, Kind: SettingKindBackupSync, Name: "本地备份目录", Code: "backup_local_dir", Type: "prefix-field", PrefixValue: ".cache/", Value: "backups", Description: "本地备份目录", Attrs: config.UrlPrefixValidatorJSON},
	...
	{Sort: 10, Kind: SettingKindThirdPartyServices, SubKind: SettingSubKindS3, Name: "S3 接口地址", Code: "s3_api_endpoint", Type: "url", Value: config.S3Endpoint, Description: "S3 兼容接口地址。"},
	{Sort: 12, Kind: SettingKindThirdPartyServices, SubKind: SettingSubKindS3, Name: "S3 Bucket", Code: "s3_bucket", Type: "text", Value: "swaves-backup", Description: "远程备份使用的 Bucket 名称。"},
	...
	{Sort: 13, Kind: SettingKindThirdPartyServices, SubKind: SettingSubKindSEE, Name: "S.EE 上传地址", Code: "asset_see_api_base", Type: "url", Value: "https://s.ee/api/v1/file/upload", Description: "S.EE 上传接口地址。"},
	{Sort: 14, Kind: SettingKindThirdPartyServices, SubKind: SettingSubKindSEE, Name: "S.EE 访问令牌", Code: "asset_see_api_token", Type: "secret", Value: config.SeeApiToken, Description: "S.EE Bearer Token。"},
	{Sort: 15, Kind: SettingKindThirdPartyServices, SubKind: SettingSubKindImageKit, Name: "ImageKit 上传地址", Code: "asset_imagekit_endpoint", Type: "url", Value: "https://upload.imagekit.io/api/v1", Description: "ImageKit 上传接口地址。"},
	...
	{Sort: 17, Kind: SettingKindThirdPartyServices, Name: "GA4 统计 ID", Code: "ga4_id", Type: "text", Value: "", Description: "Google Analytics 4 Measurement ID。"},
	...
	{Sort: 11, Kind: SettingKindDashSecurity, Name: "管理后台密码", Code: "dash_password", Type: "password", Value: "dash", Description: "管理员密码", Attrs: config.DashPasswordValidatorJSON},
	{Sort: 12, Kind: SettingKindDashSecurity, SubKind: SettingSubKindAsset, Name: "默认资源上传服务", Code: "asset_default_provider", Type: "select", Value: "see", Description: "资源上传默认使用的服务商。", Options: `[{"label":"S.EE","value":"see"},{"label":"ImageKit","value":"imagekit"}]`},
	{Sort: 10, Kind: SettingKindNotifications, Name: "文章点赞通知", Code: "notify_enable_post_like", Type: "radio", Value: "1", DefaultOptionValue: "1", Description: "文章收到点赞时发送通知（按时间窗口聚合）", Options: BooleanOptions},
	{Sort: 11, Kind: SettingKindNotifications, Name: "用户留言通知", Code: "notify_enable_comment", Type: "radio", Value: "1", DefaultOptionValue: "1", Description: "有新留言时发送通知", Options: BooleanOptions},
	{Sort: 12, Kind: SettingKindNotifications, Name: "任务成功通知", Code: "notify_enable_task_success", Type: "radio", Value: "0", DefaultOptionValue: "0", Description: "任务成功时发送通知", Options: BooleanOptions},
	{Sort: 13, Kind: SettingKindNotifications, Name: "任务失败通知", Code: "notify_enable_task_error", Type: "radio", Value: "1", DefaultOptionValue: "1", Description: "任务失败时发送通知", Options: BooleanOptions},
	...
	{Sort: 11, Kind: SettingKindUIExperience, Name: "界面模式", Code: "mode", Type: "radio", Value: "light", Description: "当前同时影响前台与后台主题模式。", DefaultOptionValue: "light", Options: `[{"label": "Light", "value": "light"}, {"label": "Dark", "value": "dark"}]`},
	...
	{Sort: 13, Kind: SettingKindUIExperience, Name: "后台导航宽度", Code: "dash_nav_width", Type: "number", Value: "150", DefaultOptionValue: "150", Description: "管理后台左侧导航栏宽度。", Attrs: config.DashNavWidthValidatorJSON},
	{Sort: 14, Kind: SettingKindUIExperience, Name: "菜单收起", Code: "dash_full_main_open", Type: "radio", Value: "0", DefaultOptionValue: "0", Description: "Dash 菜单是否收起", Options: BooleanOptions},
	{Sort: 15, Kind: SettingKindUIExperience, Name: "目录展开", Code: "dash_post_editor_toc_open", Type: "radio", Value: "0", DefaultOptionValue: "0", Description: "目录默认展开状态。", Options: BooleanOptions},
	{Sort: 16, Kind: SettingKindUIExperience, Name: "源码模式", Code: "dash_post_editor_source_mode", Type: "radio", Value: "0", DefaultOptionValue: "0", Description: "默认源码模式状态。", Options: BooleanOptions},
