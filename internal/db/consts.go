...
var DefaultSettings = []Setting{
	...
	{Sort: 50, Kind: "Post", Name: "全局路径前缀", Code: "base_path", Reload: 1, Type: "text", Value: "/", Description: "访问根路径", Attrs: consts.UrlPrefixValidatorJSON},
	{Sort: 51, Kind: "Post", Name: "页面路径前缀", Code: "page_path", Reload: 1, Type: "prefix-field", Value: "/", PrefixValue: "全局路径前缀", Description: "页面根路径", Attrs: consts.UrlPrefixValidatorJSON},
	{Sort: 52, Kind: "Post", Name: "RSS地址", Code: "rss_path", Reload: 1, Type: "prefix-field", Value: "/atom.xml", PrefixValue: "全局路径前缀", Description: "feed 地址", Attrs: consts.UrlFileNamePrefixValidatorJSON},
	{Sort: 53, Kind: "Post", Name: "文章地址前缀", Code: "post_url_prefix", Reload: 1, Type: "prefix-field", Value: "/{datetime}", PrefixValue: "全局路径前缀", Attrs: consts.PostUrlPrefixValidatorJSON, Description: "文章 URL 前缀"},
	...
	{Sort: 57, Kind: "Post", Name: "分类地址前缀", Code: "category_url_prefix", Reload: 1, Type: "prefix-field", Value: "/categories", PrefixValue: "全局路径前缀", Attrs: consts.UrlPrefixValidatorJSON, Description: "分类 URL 前缀"},
	{Sort: 58, Kind: "Post", Name: "标签地址前缀", Code: "tag_url_prefix", Reload: 1, Type: "prefix-field", Value: "/tags", PrefixValue: "全局路径前缀", Attrs: consts.UrlPrefixValidatorJSON, Description: "标签 URL 前缀"},
