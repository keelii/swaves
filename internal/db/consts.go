...
var DefaultSettings = []Setting{
	{Sort: 1, Kind: "General", Name: "访问地址", Code: "site_url", Type: "text", Value: "http://keelii.com", Description: "站点地址，不包括路径"},
	{Sort: 2, Kind: "General", Name: "站点名称", Code: "site_name", Type: "text", Value: "Swaves", Description: "站点名称"},
	{Sort: 2, Kind: "General", Name: "站点标题", Code: "site_title", Type: "text", Value: "Nothing", Description: "站点标题"},
	{Sort: 2, Kind: "General", Name: "站点描述", Code: "site_desc", Type: "text", Value: "声音是一种机械波，而博客是一种思想波。", Description: "站点描述"},
	{Sort: 5, Kind: "General", Name: "站点关键字", Code: "keyword", Type: "text", Value: "前端开发,编程,javascript,typescript,css,html,nodejs,python,java", Description: "关键字"},
	{Sort: 2, Kind: "General", Name: "版权文字", Code: "site_copyright", Type: "text", Value: "Copyright © {{year}} keelii", Description: "站点版权"},
	{Sort: 4, Kind: "General", Name: "作者", Code: "author", Type: "text", Value: "keelii", Description: "作者"},
	{Sort: 4, Kind: "General", Name: "头像", Code: "author_avatar", Type: "text", Value: "https://cdn.v2ex.com/avatar/1592/1040/7682_large.png", Description: "头像"},
	{Sort: 6, Kind: "General", Name: "站点关键字", Code: "language", Type: "select", Value: "zh-CN", Description: "语言", Options: InternalLang},
	{Sort: 7, Kind: "General", Name: "页面字符集", Code: "charset", Type: "text", Value: "utf-8", Description: "编码", Options: InternalLang},
	{Sort: 9, Kind: "General", Name: "时区", Code: "timezone", Type: "select", Value: "Asia/Shanghai", Description: "时区", Options: InternalTimezone},
	{Sort: 11, Kind: "General", Name: "管理后台密码", Code: "admin_password", Type: "password", Value: "admin", Description: "管理员密码", Attrs: `{"minlength": 6}`},
	{Sort: 11, Kind: "General", Name: "管理后台路径", Code: "admin_path", Type: "text", Value: "/admin", Description: "管理后台地址", Attrs: consts.UrlPrefixValidatorJSON},
	{Sort: 11, Kind: "Appearance", Name: "文字大小", Code: "font_size", Type: "range", Value: "14", Description: "UI font size", Attrs: `{"min": 12, "max": 20, "step": 2}`},
	{Sort: 11, Kind: "Appearance", Name: "界面模式", Code: "mode", Type: "radio", Value: "light", Description: "UI mode", DefaultOptionValue: "light", Options: `[{"label": "Light", "value": "light"}, {"label": "Dark", "value": "dark"}]`},
	...
	{Sort: 11, Kind: "Appearance", Name: "分页器每页数量", Code: "page_size", Type: "number", Value: "20", DefaultOptionValue: "10", Description: "每页显示的文章数量", Attrs: `{"min": 1, "max": 100}`},
	{Sort: 11, Kind: "Post", Name: "全局路径前缀", Code: "base_path", Reload: 1, Type: "text", Value: "/", Description: "访问根路径", Attrs: consts.UrlPrefixValidatorJSON},
	{Sort: 13, Kind: "Post", Name: "页面路径前缀", Code: "page_path", Reload: 1, Type: "text", Value: "/", Description: "页面根路径", Attrs: consts.UrlPrefixValidatorJSON},
	{Sort: 13, Kind: "Post", Name: "RSS地址", Code: "rss_path", Reload: 1, Type: "text", Value: "/atom.xml", Description: "feed 地址", Attrs: consts.UrlFileNamePrefixValidatorJSON},
	{Sort: 13, Kind: "Post", Name: "文章地址前缀", Code: "post_url_prefix", Reload: 1, Type: "text", Value: "/{datetime}", Attrs: consts.PostUrlPrefixValidatorJSON, Description: "文章 URL 前缀"},
	{Sort: 17, Kind: "Post", Name: "分类地址前缀", Code: "category_url_prefix", Reload: 1, Type: "text", Value: "/categories", Attrs: consts.UrlPrefixValidatorJSON, Description: "分类 URL 前缀"},
	{Sort: 15, Kind: "Post", Name: "标签地址前缀", Code: "tag_url_prefix", Reload: 1, Type: "text", Value: "/tags", Attrs: consts.UrlPrefixValidatorJSON, Description: "标签 URL 前缀"},
	{Sort: 19, Kind: "Data", Name: "本地备份目录", Code: "backup_local_dir", Type: "text", Value: "backups", Description: "本地备份目录（支持绝对路径或相对程序根目录路径）"},
	{Sort: 20, Kind: "Data", Name: "本地备份间隔 (min)", Code: "backup_local_interval_min", Type: "number", Value: "1440", DefaultOptionValue: "1440", Description: "两次本地备份之间的最小间隔（分钟）", Attrs: `{"min": 1, "max": 10080}`},
	{Sort: 21, Kind: "Data", Name: "本地备份最大数量", Code: "backup_local_max_count", Type: "number", Value: "30", DefaultOptionValue: "30", Description: "本地仅保留最新 N 个备份文件", Attrs: `{"min": 1, "max": 500}`},
	{Sort: 22, Kind: "Data", Name: "S3 远程备份开启", Code: "sync_push_enabled", Type: "radio", Value: "0", DefaultOptionValue: "0", Description: "是否启用通过 S3 API 的远程备份任务", Options: `[{"label": "关闭", "value": "0"}, {"label": "开启", "value": "1"}]`},
	{Sort: 23, Kind: "Data", Name: "S3 API Endpoint", Code: "sync_push_endpoint", Type: "url", Value: "", Description: "S3 API Endpoint，可在 URL 路径中带 bucket（示例：https://s3.example.com/my-bucket）"},
	{Sort: 24, Kind: "Data", Name: "S3 远程备份超时 (sec)", Code: "sync_push_timeout_sec", Type: "number", Value: "60", DefaultOptionValue: "60", Description: "S3 远程备份超时时间（秒）", Attrs: `{"min": 1, "max": 600}`},
