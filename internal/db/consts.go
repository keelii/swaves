...
var DefaultSettings = []Setting{
	...
	{Sort: 54, Kind: "Post", Name: "分类地址前缀", Code: "category_url_prefix", Reload: 1, Type: "text", Value: "/categories", Attrs: consts.UrlPrefixValidatorJSON, Description: "分类 URL 前缀"},
	{Sort: 55, Kind: "Post", Name: "标签地址前缀", Code: "tag_url_prefix", Reload: 1, Type: "text", Value: "/tags", Attrs: consts.UrlPrefixValidatorJSON, Description: "标签 URL 前缀"},
