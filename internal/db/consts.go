...
var DefaultSettings = []Setting{
	...
	{Sort: 12, Kind: SettingKindContentRouting, Name: "RSS地址", Code: "rss_path", Reload: 1, Type: "prefix-field", Value: "atom.xml", PrefixValue: "/", Description: "feed 地址", Attrs: consts.UrlFileNamePrefixValidatorJSON},
	{Sort: 13, Kind: SettingKindContentRouting, Name: "文章地址前缀", Code: "post_url_prefix", Reload: 1, Type: "prefix-field", Value: "{datetime}", PrefixValue: "/", Attrs: consts.PostUrlPrefixValidatorJSON, Description: "文章 URL 前缀"},
	...
	{Sort: 10, Kind: SettingKindBackupSync, Name: "远程备份开启", Code: "sync_push_enabled", Type: "radio", Value: "0", DefaultOptionValue: "0", Description: "", Options: `[{"label": "关闭", "value": "0"}, {"label": "开启", "value": "1"}]`},
	...
	{Sort: 10, Kind: SettingKindThirdPartyServices, SubKind: SettingSubKindS3, Name: "S3 API Endpoint", Code: "s3_api_endpoint", Type: "url", Value: consts.S3Endpoint, Description: "S3 API Endpoint"},
