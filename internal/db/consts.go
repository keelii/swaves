...
var DefaultSettings = []Setting{
	...
	{Sort: 16, Kind: "General", Name: "作者", Code: "author", Type: "text", Value: "keelii", Description: "作者"},
	{Sort: 17, Kind: "General", Name: "头像", Code: "author_avatar", Type: "text", Value: "https://cdn.v2ex.com/avatar/1592/1040/7682_large.png", Description: "头像"},
	{Sort: 18, Kind: "General", Name: "站点关键字", Code: "language", Type: "select", Value: "zh-CN", Description: "语言", Options: InternalLang},
	...
	{Sort: 55, Kind: "Post", Name: "文章地址名称", Code: "post_url_name", Type: "text", Value: "{slug}", Description: "分类 URL 前缀，可选：{slug}, {id}, {title}", Attrs: consts.PostUrlNameValidatorJSON},
	...
	{Sort: 57, Kind: "Post", Name: "分类地址前缀", Code: "category_url_prefix", Reload: 1, Type: "text", Value: "/categories", Attrs: consts.UrlPrefixValidatorJSON, Description: "分类 URL 前缀"},
	{Sort: 58, Kind: "Post", Name: "标签地址前缀", Code: "tag_url_prefix", Reload: 1, Type: "text", Value: "/tags", Attrs: consts.UrlPrefixValidatorJSON, Description: "标签 URL 前缀"},
