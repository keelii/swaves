...
func (h *Handler) GetCategoryListHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "sui/categories_index.html", fiber.Map{
		"Title":      "Categories",
...
func (h *Handler) GetCategoryTreeHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "sui/categories_tree.html", fiber.Map{
		"Title":           "Category Tree",
		"Tree":            tree,
...
func (h *Handler) GetCategoryNewHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "sui/categories_new.html", fiber.Map{
		"Title":           "New Category",
		"Categories":      all,
...
func (h *Handler) GetCategoryEditHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "sui/categories_edit.html", fiber.Map{
		"Title":           "Edit Category",
		"Category":        category,
