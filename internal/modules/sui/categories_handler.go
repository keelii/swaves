...
func (h *Handler) GetCategoryListHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "categories_index", fiber.Map{
		"Title":      "Categories",
...
func (h *Handler) GetCategoryTreeHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "categories_tree", fiber.Map{
		"Title":           "Category Tree",
		"Tree":            tree,
...
func (h *Handler) GetCategoryNewHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "categories_new", fiber.Map{
		"Title":           "New Category",
		"Categories":      all,
...
func (h *Handler) GetCategoryEditHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "categories_edit", fiber.Map{
		"Title":           "Edit Category",
		"Category":        category,
