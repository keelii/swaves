...
func (h *Handler) GetPostListHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "sui/posts_index.html", fiber.Map{
		"Title":                   "Posts",
		"Posts":                   posts,
		"Pager":                   pager,
		"Kind":                    kind,
...
func (h *Handler) renderPostNew(c fiber.Ctx, data fiber.Map) error {
	...
	return RenderSUIView(c, "sui/posts_new.html", data, "")
}
...
func (h *Handler) GetPostEditHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "sui/posts_edit.html", fiber.Map{
		"Title":            "Edit Post",
