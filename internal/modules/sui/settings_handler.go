...
func (h *Handler) GetSettingsHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "settings_index", fiber.Map{
		"Title":    "Settings",
		"Settings": settings,
	}, "")
}
...
func (h *Handler) GetSettingsAllHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "settings_all", fiber.Map{
...
func (h *Handler) GetSettingEditHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "settings_edit", fiber.Map{
		"Title":   "Edit Setting",
		"Setting": view,
	}, "")
}
...
func (h *Handler) GetSettingNewHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "settings_new", fiber.Map{
		"Title":              "New Setting",
