...
func (h *Handler) GetSettingsHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "sui/settings_index.html", fiber.Map{
		"Title":    "Settings",
		"Settings": settings,
	}, "")
}
...
func (h *Handler) GetSettingsAllHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "sui/settings_all.html", fiber.Map{
...
func (h *Handler) GetSettingEditHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "sui/settings_edit.html", fiber.Map{
		"Title":   "Edit Setting",
		"Setting": view,
	}, "")
}
...
func (h *Handler) GetSettingNewHandler(c fiber.Ctx) error {
	...
	return RenderSUIView(c, "sui/settings_new.html", fiber.Map{
		"Title":              "New Setting",
