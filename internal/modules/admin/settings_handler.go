...
func (h *Handler) GetSettingsAllHandler(c fiber.Ctx) error {
	...
	return RenderAdminView(c, "dash/settings_all.html", fiber.Map{
...
func (h *Handler) GetSettingEditHandler(c fiber.Ctx) error {
	...
	return RenderAdminView(c, "dash/settings_edit.html", fiber.Map{
		"Title":   "Edit Setting",
		"Setting": view,
	}, "")
}
...
func (h *Handler) GetSettingNewHandler(c fiber.Ctx) error {
	...
	return RenderAdminView(c, "dash/settings_new.html", fiber.Map{
		"Title":              "New Setting",
