...
func RegisterRouter(
	...
	dashGroup.Post("/api/settings/dash-post-editor-source-mode", handler.PostUpdateDashPostEditorSourceModeAPIHandler).Name("dash.settings.api.post_editor_source_mode.update")
